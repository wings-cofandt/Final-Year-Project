...
class App(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.title = 'Personality Prediction through Text Input'
...
"")
    ...
    def on_click(self):
        ...
        if trait=='ISTP':
            exp='ISTP indicates a person who is energized by time spent alone (Introverted), who focuses on facts and \ndetails rather than ideas and concepts (Sensing), who makes decisions based on logic and reason \n(Thinking) and who prefers to be spontaneous and flexible rather than planned and \norganized (Perceiving).'
        
        if trait=='ISFP':
            exp='ISFPs are gentle caretakers who live in the present moment and enjoy their surroundings with cheerful, \nlow-key enthusiasm. They are flexible and spontaneous, and like to go with the flow to enjoy \nwhat life has to offer. ISFPs are quiet and unassuming, and may be hard to get to know.'
