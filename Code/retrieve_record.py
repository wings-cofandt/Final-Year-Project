# -*- coding: utf-8 -*-
"""
Created on Wed Apr 14 10:53:58 2021
...
"{\n"
"    border: 2px solid QLinearGradient( x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 black, stop: 3 black);\n"
"}\n"
"\n"
"\n"
"QComboBox:on\n"
...
"}")
        ...
        self.label.setStyleSheet("font: 75 30pt \"Segoe UI Black\";qproperty-alignment: AlignCenter;")
        self.horizontalLayout.addWidget(self.label)  #font: 87 16pt \"Segoe UI Black\"
        ...
        self.pushButton.setStyleSheet("font: 87 18pt \"Segoe UI Black\";color:black;background-color:orange")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Retrieve Records"))
        self.label.setText(_translate("Form", "Retrieve Records of Textual Dataset from Database"))
...
#            dbname = self.lineEditDb.text()
 #           tablename = self.lineEditTable.text()
            ...
            mycursor.execute("SELECT * FROM {} ".format('txt_dataset'))
