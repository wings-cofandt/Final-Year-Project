...
def image_predict(path):
       ...
       cv2.putText(img,labels[index_pred],(10,50), font, 1,(2,255,255),2)
...
"")
        ...
        self.heading.setStyleSheet("font: 87 32pt \"Segoe UI Black\";")
        self.heading.setGeometry(QtCore.QRect(20, 20, 651, 61))
        
        
        self.headin = QLabel('Prediction Through Images', self)

        self.headin.setStyleSheet("font: 75 20pt \"Segoe UI Black\";\n color:orange;")
        self.headin.setGeometry(QtCore.QRect(20, 120, 651, 61))
        import images_rc
        
        self.label_4 = QtWidgets.QLabel()
        self.label_4.setGeometry(QtCore.QRect(30, 280, 391, 291))
        ...
        self.button.setGeometry(QtCore.QRect(20, 260, 161, 81))
        # connect button to function on_click
        self.button.clicked.connect(self.on_click)
        
        
        self.buttonc = QPushButton('Close Camera', self)

        self.buttonc.setStyleSheet("font-size:  22px;\n" "background-color:black")
        self.buttonc.setGeometry(QtCore.QRect(220, 360, 161, 81))
        # connect button to function on_click
        self.buttonc.clicked.connect(self.close)
        ...
        #
        # Create a button in the window
        self.buttong = QPushButton('Live Camera', self)

        self.buttong.setStyleSheet("font-size:  22px;\n" "background-color:black")
        self.buttong.setGeometry(QtCore.QRect(20, 360, 161, 81))
        # connect button to function on_click
    ...
    def image_predict(path):
        ...
        index_pred = np.argmax(array_preds)
        #print(labels[index_pred])
        import fontFace,fontScale,color
        color=cv2.red
        font = cv2.FONT_HERSHEY_SIMPLEX
        cv2.putText(img, labels[index_pred], (10,500), fontFace, fontScale, color)
